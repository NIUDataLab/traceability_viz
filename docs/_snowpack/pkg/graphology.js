...
var support = {
	ARRAY_BUFFER_SUPPORT: ARRAY_BUFFER_SUPPORT,
...
var ARRAY_BUFFER_SUPPORT$1 = support.ARRAY_BUFFER_SUPPORT;
var SYMBOL_SUPPORT$1 = support.SYMBOL_SUPPORT;
...
function iterOrNull(target) {
  ...
  if (
    ...
    (ARRAY_BUFFER_SUPPORT$1 && ArrayBuffer.isView(target))
  )
  ...
  // Iterable
  if (SYMBOL_SUPPORT$1 && typeof target[Symbol.iterator] === 'function')
